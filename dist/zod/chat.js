...
const MessageSchema = z.object({
  ...
  role: z.enum(["system", "user", "assistant", "data"]).describe("The 'data' role is deprecated"),
  data: JsonValueSchema.optional().describe(
    "Deprecated: Data messages will be removed"
  ),
  annotations: z.array(JsonValueSchema).optional().describe("Additional message-specific information"),
  toolInvocations: z.array(ToolInvocationSchema).optional().describe("Deprecated: Use parts instead"),
  parts: z.array(UIPartSchema).describe("The parts of the message for UI rendering")
});
